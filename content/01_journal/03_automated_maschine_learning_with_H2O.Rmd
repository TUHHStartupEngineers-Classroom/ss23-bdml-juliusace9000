...
definitions_list <- definitions_tbl %>% 
  ...
  # Mapping over lists and Split into multiple tibbles
  split(.$column_name) %>%
  # Remove column_name
...
automl_models_h2o@leaderboard %>% 
  ...
  #h2o.saveModel(path = "")
h2o.getModel("StackedEnsemble_AllModels_3_AutoML_1_20230524_103830") %>% 
  h2o.saveModel(path = "./", force = TRUE)

h2o.loadModel("StackedEnsemble_AllModels_3_AutoML_1_20230524_103830")

# Choose whatever model you want
stacked_ensemble_h2o <- h2o.loadModel("StackedEnsemble_AllModels_3_AutoML_1_20230524_103830")
...
deep_learning_h2o <- h2o.loadModel("StackedEnsemble_AllModels_3_AutoML_1_20230524_103830")
...
leader_model %>% h2o.saveModel(path = "")
```